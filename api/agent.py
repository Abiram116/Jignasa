    ...
    *,
    ...
    decision_messages: list[dict] = [{
        ...
        "content": (
            ...
            "further tool call.\n"
            "- Treat any question asking what something is, how it works, or to "
            "explain a technical/domain concept (e.g. 'what does X do', 'explain "
            "how Y works') as something to run through rag_search FIRST, even if "
            "you already recognize the general topic -- the user's documents may "
            "define or frame it differently than your training data, and grounding "
            "the answer in their own source is the whole point of Jignasa's "
            "document mode. Do not answer such questions from memory alone.\n"
